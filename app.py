...
def apply_po_ui():
    ...
    <style>
        .hero-header {
            ...
            box-shadow: 0px 4px 15px rgba(0,0,0,0.5); border-left: 8px solid #007BFF;
        }
        .hero-text { color: white !important; margin: 0 !important; font-size: 24px !important; font-weight: 800 !important; }
        .m-box-po {
            background: linear-gradient(135deg, #1a1d2e 0%, #252a3d 100%) !important;
            padding: 22px; border-radius: 10px; border-left: 5px solid #00d2ff;
            box-shadow: 2px 10px 20px rgba(0,0,0,0.4); margin-bottom: 10px; min-height: 120px;
        }
        .m-lbl { color: #8a8d9a !important; font-size: 11px !important; font-weight: 700 !important; text-transform: uppercase !important; display: block !important; margin-bottom: 10px !important;}
        .m-val { color: #C5A059 !important; font-size: 30px !important; font-weight: 800 !important; display: block !important; }
        
        /* Style uploader agar kontras */
        [data-testid="stFileUploader"] { background-color: #ffffff !important; color: black !important; padding: 10px; border-radius: 8px; }
        [data-testid="stFileUploader"] label { color: black !important; font-weight: bold; }
    </style>
    """, unsafe_allow_html=True)
