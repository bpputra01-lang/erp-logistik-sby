...
if not st.session_state.get('logged_in', False):
    st.markdown("""
        ...
        /* Hilangkan elemen bawaan Streamlit yang mengganggu */
        ...
        /* 3. Input Box - PERBAIKAN TEKS TENGAH VERTIKAL */
        /* Container luar input */
        div[data-baseweb="input"] {
            background-color: #1a2634 !important;
            border: 1px solid #C5A059 !important;
            border-radius: 10px !important;
            padding: 0 16px !important; /* Padding horizontal saja */
            height: 55px !important;    /* Tinggi fix agar konsisten */
            display: flex !important;
        ...
        div[data-baseweb="input"] input {
            ...
            height: 100% !important; /* Isi seluruh tinggi container */
        ...
        /* Ikon Mata Password agar di tengah */
        ...
        /* Placeholder */
        input::placeholder { color: rgba(197, 160, 89, 0.4) !important; }
        ...
        div.stFormSubmitButton > button {
            ...
            height: 55px !important; /* Samakan tinggi dengan input agar simetris */
