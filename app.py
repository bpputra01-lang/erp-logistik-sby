...
if menu == "📊 Dashboard Overview":
    ...
    st.markdown(f'''
        <div class="dash-container" style="height: auto; min-height: 400px; overflow: hidden; margin-bottom: 0px;">
            <div style="width: 100%; height: 440px; overflow: auto; border-radius: 10px; background: #f8f9fa;">
                ...
                style="width: 4000px; height: 1700px; border: none; transform: scale({zoom}); transform-origin: 0 0;"></iframe>
            </div>
        </div>
